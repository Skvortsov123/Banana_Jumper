...
public class FallingPlatform : MonoBehaviour
{
    ...
    public float disableColliderDelay = 0.3f;  // Tid innan collidern stängs av (när luckan öppnas)
    public float enableColliderDelay = 1.5f;   // Tid innan collidern aktiveras igen (när luckan stängts)
